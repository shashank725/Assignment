...
async def analyze_message(message = "John likes the blue house at the end of the street."):
    ...
    print(figures_of_speech, type(figures_of_speech))
    return figures_of_speech

async def main():
    result = await analyze_message()
    print(json.dumps(result), type(json.dumps(result)))
